		...
		Если Результат.Свойство("result") Тогда
			...
			Для Каждого Маршрут Из Маршруты Цикл
				...
				Для Каждого ТочкаДоставки ИЗ ТочкиДоставки Цикл 
					...
					НовСтрТочкиДоставки.service_duration_s	= ТочкаДоставки.node.value.service_duration_s;
					НовСтрТочкиДоставки.shared_service_duration_s = ТочкаДоставки.node.value.shared_service_duration_s;
